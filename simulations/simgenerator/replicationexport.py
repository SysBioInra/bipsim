...
class ReplicationExport(object):
    ...
    def input(self):
        ...
        lines.append(free_chemical(['DnaA_ATP'], [2]))
    ...
    def initiation(self):
        ...
        lines.append(free_chemical(['DnaA_ADP']))
        ...
        lines.append('\n')
        lines.append('SequenceBinding DnaA_ATP bound_DnaA DnaA_BS\n')
        lines.append('ChemicalReaction free_DNAP -1 bound_DnaA -1 '
                     'DNAP_fork 1 DnaA_ADP 1 Pi 1 rates 1 0\n')
        lines.append('\n')
        return ''.join(lines)
